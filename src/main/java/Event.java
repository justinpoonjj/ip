public class Event extends Task{
    ...
    public void printMessage(int index) {
        ...
        System.out.println("[" + this.taskType() + "]"+"["+ this.getStatusIcon()+"] " + this.TaskDescription + "(" + this.getTimeRange() + ")");
    ...
    public void printList(int index) {
        System.out.println((index+1) + "." + "[" + this.taskType() + "]"+"["+ this.getStatusIcon()+"] " + this.TaskDescription + "(" + this.getTimeRange() + ")");
    }
}
